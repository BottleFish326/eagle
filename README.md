...
阶段 0、阶段 1 与阶段 2 已通过验收。阶段 2 的 P2-01 至 P2-08、P2-A11 100,000 素材连续 8 小时正式验收、P2-A12 GitHub-hosted macOS/Linux/Windows 原生矩阵、统一外部门禁、本地故障、数据安全和最终退出重放全部通过。阶段 3 已进入 P3-01A：静态格式识别、非解码格式记录保留和首个真实夹具清单已实现，preview/provider、UI 与查询贯通仍在开发。SSH origin、`main` 与托管 CI 已就绪。开发阶段、交付物和验收规范见：

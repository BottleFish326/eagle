...
| 阶段 3：完整素材能力 | In progress | P3-01A/B/D/E 已本地完成，P3-01C 已通过三平台成品重放，视频帧 worker 已按发行边界暂缓；下一动作 P3-01F |
...
| 准备项 | 状态 | 证据 |
|---|---|---|
| P3-01 扩展格式能力管线 | In progress | P3-01A/B/D/E Completed locally；P3-01C 已通过三平台固定 libheif backend 与成品重放；MP4/MOV/WebM 具有有界属性，MP3/WAV/FLAC 具有有界属性且 MP3/FLAC 封面已接入，视频帧 worker 按 decoder allowlist/LGPL/专利门禁暂缓；P3-A01/A02 未判定，下一动作 P3-01F，见 `reports/p3-01a-acceptance.md` 至 `reports/p3-01e-acceptance.md` |

...
| 阶段 3：完整素材能力 | In progress | P3-01A/B 已本地完成；P3-01C 的固定 libheif 1.23.1 backend 已通过 Linux 托管真实解码，桌面 preview 授权接线已本地实现，下一动作是构建期清单、三平台随包和恶意夹具 |

...
| 阶段 3：完整素材能力 | In progress | P3-01A 注册表/通用类型卡片与 P3-01B SVG 已本地完成；下一动作是 P3-01C AVIF/HEIC |
...
| 准备项 | 状态 | 证据 |
|---|---|---|
| P3-01 扩展格式能力管线 | In progress | P3-01A/B Completed locally：注册表、通用卡片、类型查询及 SVG 有界属性/确定性 PNG/活动内容与外部引用隔离已通过；P3-A01/A02 未判定，下一片 P3-01C，见 `reports/p3-01a-acceptance.md`、`reports/p3-01b-acceptance.md` |

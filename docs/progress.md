...
| 阶段 3：完整素材能力 | In progress | P3-01A/B 已本地完成；P3-01C 已通过三平台固定 libheif 1.23.1 backend、参考 PNG 与 DEB/`.app`/NSIS 成品重放，下一动作是 P3-01D 视频 |
...
| 准备项 | 状态 | 证据 |
|---|---|---|
| P3-01 扩展格式能力管线 | In progress | P3-01A/B Completed locally；P3-01C 已通过 core-only 降级、有界 worker、三平台固定 libheif backend、恶意集合及 DEB/`.app`/NSIS 成品内 runtime 重放；P3-A01/A02 未判定，下一动作 P3-01D，见 `reports/p3-01a-acceptance.md`、`reports/p3-01b-acceptance.md`、`reports/p3-01c-acceptance.md` |

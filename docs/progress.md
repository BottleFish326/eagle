...
| 阶段 2 退出验收 | Draft / Not accepted | P2-A01 至 P2-A10 已汇总；只读状态编排器覆盖长稳、托管、外部汇总、本地故障和最终收据的完整状态转换；两类 accepted-only 收据写盘前独立自检；最终验证器重放 A11/A12 并核对源码漂移、证据归属与四段 commit 顺序；P2-A11 正式任务运行中，P2-A12 等待托管结果；见 `reports/phase-2-acceptance.md` |

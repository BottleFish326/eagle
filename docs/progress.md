...
| 阶段 3：完整素材能力 | In progress | P3-01A/B 已本地完成；P3-01C 的严格 brand 识别、真实夹具、codec 缺失降级和有界 worker 隔离协议已通过，下一动作是固定 libheif backend 与三平台打包 |
...
| 准备项 | 状态 | 证据 |
|---|---|---|
| P3-01 扩展格式能力管线 | In progress | P3-01A/B Completed locally；P3-01C 已具备严格 ISO BMFF brand 识别、真实 AVIF/HEIC 夹具、无缓存 codec 降级和一请求一进程 worker 边界，libheif backend/打包尚未实现；P3-A01/A02 未判定，见 `reports/p3-01a-acceptance.md`、`reports/p3-01b-acceptance.md`、`reports/p3-01c-readiness.md` |

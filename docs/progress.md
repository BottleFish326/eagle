...
| P2-08 平台与文件系统兼容 | Acceptance pending | macOS 原生 10 项通过；证据器精确要求 macOS/Linux/Windows 10/12/9 项、拒绝 skip 并上传 commit-bound JSON；P2-A12 首次远程运行仍待完成；见 `reports/p2-08-acceptance.md` |

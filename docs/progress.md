...
| 阶段 3：完整素材能力 | In progress | P3-01A/B 已本地完成，P3-01C 已通过三平台成品重放，P3-01D 容器属性已本地完成且视频帧 worker 已按发行边界暂缓；下一动作 P3-01E |
...
| 准备项 | 状态 | 证据 |
|---|---|---|
| P3-01 扩展格式能力管线 | In progress | P3-01A/B Completed locally；P3-01C 已通过三平台固定 libheif backend 与成品重放；P3-01D 已完成 MP4/MOV/WebM 有界属性、未知 codec 降级及 9 个确定性夹具，视频帧 worker 按 decoder allowlist/LGPL/专利门禁暂缓；P3-A01/A02 未判定，下一动作 P3-01E，见 `reports/p3-01a-acceptance.md`、`reports/p3-01b-acceptance.md`、`reports/p3-01c-acceptance.md`、`reports/p3-01d-acceptance.md` |
